...
---
title: "Nanostring QC, Normalizationusing and DE using the RUVg and RUVIII"
...
```
Extract the the info from data
#######################################################
```{r}
require(EnvStats)
...
#### DEseq on normlized Set using RUVg
...
filename <- paste0('Deseq_ruvg_k_',k,'_DEA.csv')
